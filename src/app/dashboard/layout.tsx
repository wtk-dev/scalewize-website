        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              <Image src="/scalewize_cover_logo.png" alt="Henly AI Cover Logo" width={360} height={80} 
      ...
      <div className={`hidden lg:fixed lg:inset-y-0 lg:flex lg:flex-col transition-all duration-300 ${sidebarCollapsed ? 'lg:w-16' : 'lg:w-64'}`}>
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          <div className="flex h-16 items-center px-4 justify-between">
            <div className="flex items-center">
              {!sidebarCollapsed && (
                <Image src="/scalewize_cover_logo.png" alt="Henly AI Cover Logo" width={360} height={80} className="h-16 w-auto" />
              )}
            </div>
            <button
