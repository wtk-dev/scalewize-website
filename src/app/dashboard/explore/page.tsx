              ...
              <div className="mt-6">
                {solution.status === 'available' ? (
                  <button
                    ...
                    className="w-full bg-white border-2 border-green-600 style="color: #595F39" hover:style="backgroundColor: #595F39" hover:text-white px-4 py-2 rounded-md text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                  ...
                  <button
                    onClick={() => handleAddToTeam(solution.id)}
                    disabled={selectedSolution === solution.id}
                    className="w-full style="backgroundColor: #595F39" text-white hover:opacity-90 px-4 py-2 rounded-md text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {selectedSolution === solution.id ? (
                      <>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="w-12 h-12 rounded-full style="backgroundColor: rgba(89, 95, 57, 0.2)" flex items-center justify-center mx-auto mb-3">
              <span className="style="color: #595F39" font-bold">1</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 rounded-full style="backgroundColor: rgba(89, 95, 57, 0.2)" flex items-center justify-center mx-auto mb-3">
              <span className="style="color: #595F39" font-bold">2</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 rounded-full style="backgroundColor: rgba(89, 95, 57, 0.2)" flex items-center justify-center mx-auto mb-3">
              <span className="style="color: #595F39" font-bold">3</span>
            </div>
