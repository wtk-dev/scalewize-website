  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-amber-50/30" style={{ background: 'linear-gradient(135deg, #f8f7f4 0%, #f0ede8 50%, #faf9f6 100%)' }} />
        ...
        <div className="relative z-20 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl text-gray-800 max-w-4xl mx-auto leading-relaxed font-light mb-8"
            >
            ...
            >
              ...
              >
                <Link 
                  href="#book-call" 
                  className="inline-flex items-center text-white px-10 py-4 rounded-2xl text-lg font-medium transition-all duration-500 ease-out shadow-xl hover:shadow-2xl"
                  style={{ backgroundColor: '#595F39' }}
                >
                  Book a Call
              ...
              >
                <Link 
                  href="#solutions" 
                  className="inline-flex items-center text-gray-700 hover:text-gray-900 px-10 py-4 rounded-2xl text-lg font-medium transition-all duration-500 ease-out border-2 border-gray-200 hover:border-gray-300"
                >
                  View Solutions
                </Link>
              </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 rounded-3xl blur-3xl scale-110 animate-pulse" style={{ background: 'rgba(89, 95, 57, 0.15)' }} />
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-gray-800 leading-relaxed font-light max-w-4xl mx-auto">
      ...
      <section id="solutions" className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-gray-800 max-w-4xl mx-auto font-light">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-20 font-light">Agents & automations that improve your bottom line</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-16">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-8 font-light text-lg">START UNLOCKING TIME TODAY!</p>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Email*" 
